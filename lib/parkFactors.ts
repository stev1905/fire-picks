...
export const PARK_FACTORS: Record<number, {
  ...
  3:    { name: "Fenway Park",                       factor: 1.08, label: "Hitter Friendly",       lat: 42.347,  lng: -71.097,   lf: 310, rf: 302, cfBearing:  95 },
  ...
  2392: { name: "Minute Maid Park",                  factor: 0.99, label: "Neutral",               lat: 29.757,  lng: -95.356,   lf: 315, rf: 326, cfBearing: 245 },
  // Globe Life Field is climate-controlled and keeps roof closed — treat as indoor
